...
public class EraseQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                Intent intent = new Intent (EraseQuestion.this,Erase_The_Question.class);
    ...
    //Ao acabar a eliminação de uma questão
